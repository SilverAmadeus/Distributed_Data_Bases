...
CREATE TABLE STAT_LAP_F1_AJRG_S1(
...
CREATE TABLE HIST_STAT_LAP_F2_AJRG_S1(
    ...
    REFERENCES STAT_LAP_F1_AJRG_S1(STATUS_LAPTOP_ID),
    CONSTRAINT FECHA_MAYOR_2009 
    CHECK(TO_NUMBER(TO_CHAR(FECHA_MOVIMIENTO,'YYYY'))>2009)
);
...
CREATE TABLE LAP_INV_F2_AJRG_S1(
    ...
    CONSTRAINT RefSTAT_LAP_F1_AJRG_S19 FOREIGN KEY (STATUS_LAPTOP_ID)
    REFERENCES STAT_LAP_F1_AJRG_S1(STATUS_LAPTOP_ID)
);
...
CREATE TABLE TIPO_ALMAC_F1_AJRG_S1(
...
CREATE TABLE TIPO_MON_F1_AJRG_S1(
...
CREATE TABLE TIPO_PROC_F1_AJRG_S1(
...
CREATE TABLE TIPO_TARJ_VID_F1_AJRG_S1(
...
CREATE TABLE LAPTOP_F1_AJRG_S1(
    ...
    REFERENCES TIPO_ALMAC_F1_AJRG_S1(TIPO_ALMACENAMIENTO_ID),
    CONSTRAINT LAPTOP_MONITOR_FK FOREIGN KEY (TIPO_MONITOR_ID)
    REFERENCES TIPO_MON_F1_AJRG_S1(TIPO_MONITOR_ID),
    CONSTRAINT LAPTOP_PROCESADOR_FK FOREIGN KEY (TIPO_PROCESADOR_ID)
    REFERENCES TIPO_PROC_F1_AJRG_S1(TIPO_PROCESADOR_ID),
    CONSTRAINT LAPTOP_VIDEO_FK FOREIGN KEY (TIPO_TARJETA_VIDEO_ID)
    REFERENCES TIPO_TARJ_VID_F1_AJRG_S1(TIPO_TARJETA_VIDEO_ID),
...
CREATE TABLE SERV_LAP__F1_AJRG_S1(
