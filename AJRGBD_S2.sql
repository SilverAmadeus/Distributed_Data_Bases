...
CREATE TABLE STAT_LAP_F2_AJRG_S2(
...
CREATE TABLE TIPO_ALMAC_F2_AJRG_S2(
...
CREATE TABLE TIPO_MON_F2_AJRG_S2(
...
CREATE TABLE TIPO_PRO_F2_AJRG_S2(
...
CREATE TABLE TIPO_TARJ_VID_F2_AJRG_S2(
...
CREATE TABLE SUCURSAL_F2_AJRG_S2(
    ...
    LATITUD        BINARY_FLOAT     NOT NULL, --------------------------------------LEL
    LONGITUD       BINARY_FLOAT     NOT NULL, -------------------------------------LEL
...
-- 
-- TABLE: "SUC_TALLER _F2_AJRG_S2" 
--

CREATE TABLE "SUC_TALLER _F2_AJRG_S2"(
    SUCURSAL_ID          NUMBER(10, 0)    NOT NULL,
...
-- 
-- TABLE: "SUC_VENTA _F2_AJRG_S2" 
--

CREATE TABLE "SUC_VENTA _F2_AJRG_S2"(
    SUCURSAL_ID      NUMBER(10, 0)    NOT NULL,
