...
create or replace trigger t_dml_laptop_s1
...
begin
	case 
		when inserting then
			...
			if substr(:new.num_serie,1,1) = '0' or substr(:new.num_serie,1,1) = '1' then
			...
			elsif substr(:new.num_serie,1,1) = '4' or substr(:new.num_serie,1,1) = '5' then
